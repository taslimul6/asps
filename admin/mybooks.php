...
$db = mysqli_query($connection, "SELECT * FROM books WHERE auther = '$name' ORDER BY id DESC");
              ...
              foreach($db as $line){ ?>
                ...
                <div class="col-sm-10 m-auto">
                    ...
                    <div class="card-body">
                        ...
                        <a href="editbook.php?id=<?php echo $line['book_id'];?>" class="btn btn-primary">Edit Book</a>
                    </div>
                    </div>
                </div>
                <?php }

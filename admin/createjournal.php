...
if (isset($_POST['upload'])){
  ...
  $uploaded = mysqli_query($connection , "INSERT INTO journal( title, description , superviser, student_name , date, journalid) VALUES('$title', '$description' , '$superviser' , '$student'  , '$today' , '$journalid');");
  if(isset($uploaded)){

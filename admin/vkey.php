...
if(isset($_POST['submit'])){
    $roll= $_POST['roll'];
    $dbz = mysqli_query($connection , "SELECT * FROM teachers WHERE email = $email;");
    ...
    <div class="container ">
        ...
        <div class="row center mt-5 ">
            <div class="col">
                ...
                <h5 class="welcome">Thank You for registration.To active your account ,enter your email adress below   
                </h5>
                <form action="" method="post">
                    <Label class="text-bold">Email Adress</Label>

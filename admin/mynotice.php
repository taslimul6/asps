...
$dbn = mysqli_query($connection, "SELECT * FROM notices WHERE auther = '$name' ORDER BY id DESC");
        ...
        <div class="col-sm-10 m-auto">
          ...
          <div class="card mt-3">
            <div class="card-body">
                ...
                <a href="editnotice.php?id=<?php echo $line['noticeid'];?>" class="btn btn-primary">Edit Notice</a>
            </div>
          </div>
